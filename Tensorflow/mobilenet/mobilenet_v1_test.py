...
class MobilenetV1Test(tf.test.TestCase):
  ...
  def testBuildClassificationNetwork(self):
    global numbers
    numbers += 1
    print('testBuildClassificationNetwork: ',numbers)
    batch_size = 5
  ...
  def testBuildPreLogitsNetwork(self):
    global numbers
    numbers += 1
    print('testBuildPreLogitsNetwork: ',numbers)
    batch_size = 5
    height, width = 224, 224
    num_classes = None
  ...
  def testBuildAndCheckAllEndPointsUptoConv2d_13(self):
    global numbers
    numbers += 1
    print('testBuildAndCheckAllEndPointsUptoConv2d_13: ',numbers)
    batch_size = 5
    height, width = 224, 224
  ...
  def testOutputStride16BuildAndCheckAllEndPointsUptoConv2d_13(self):
    global numbers
    numbers += 1
    print('testOutputStride16BuildAndCheckAllEndPointsUptoConv2d_13: ',numbers)
    batch_size = 5
    height, width = 224, 224
    output_stride = 16
  ...
  def testBuildEndPointsWithDepthMultiplierLessThanOne(self):
    global numbers
    numbers += 1
    print('testBuildEndPointsWithDepthMultiplierLessThanOne: ',numbers)
    batch_size = 5
    height, width = 224, 224
    num_classes = 1000
  ...
  def testBuildEndPointsWithDepthMultiplierGreaterThanOne(self):
    global numbers
    numbers += 1
    print('testBuildEndPointsWithDepthMultiplierGreaterThanOne: ',numbers)
    batch_size = 5
    height, width = 224, 224
    num_classes = 1000
  ...
  def testRaiseValueErrorWithInvalidDepthMultiplier(self):
    global numbers
    numbers += 1
    print('testRaiseValueErrorWithInvalidDepthMultiplier: ',numbers)
    batch_size = 5
    height, width = 224, 224
    num_classes = 1000
  ...
  def testHalfSizeImages(self):
    global numbers
    numbers += 1
    print('testHalfSizeImages: ',numbers)
    batch_size = 5
  ...
  def testUnknownImageShape(self):
    global numbers
    numbers += 1
    print('testUnknownImageShape: ',numbers)
  ...
  def testGlobalPoolUnknownImageShape(self):
    global numbers
    numbers += 1
    print('testGlobalPoolUnknownImageShape: ',numbers)
    tf.reset_default_graph()
    batch_size = 1
  ...
  def testUnknowBatchSize(self):
    global numbers
    numbers += 1
    print('testUnknowBatchSize: ',numbers)
    batch_size = 1
    height, width = 224, 224
    num_classes = 1000
  ...
  def testTrainEvalWithReuse(self):
    global numbers
    numbers += 1
    print('testTrainEvalWithReuse: ',numbers)
    train_batch_size = 5
    eval_batch_size = 2
  ...
  def testLogitsNotSqueezed(self):
    global numbers
    numbers += 1
    print('testLogitsNotSqueezed: ',numbers)
    num_classes = 25
  ...
  def testBatchNormScopeDoesNotHaveIsTrainingWhenItsSetToNone(self):
    global numbers
    numbers += 1
    print('testBatchNormScopeDoesNotHaveIsTrainingWhenItsSetToNone: ',numbers)
